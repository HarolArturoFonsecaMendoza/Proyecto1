...
<h1 class="container">Editar Tarea</h1>
...
<form method ="post" action="{{route('tarea.update', ['id' => $tarea->id])}}">
    ...
    <div class="form-group">
        <label for="nombre">Nombre del tarea</label>
        <input type="text" class="form-control" name = "nombre"id="nombre" 
        placeholder="escriba el nombre del tarea" value="{{$tarea->nombre}}">
    </div><br>

    <div class="form-group">
        <label for="descripcion">Descripcion del tarea</label>
        <input type="text" class="form-control" name = "descripcion"id="descripcion" 
        placeholder="escriba la descripcion" value="{{$tarea->descripcion}}">
    </div><br>
